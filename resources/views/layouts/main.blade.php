...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('dashboard') }}" class="logo">
            ...
            <span class="logo-lg"><b>Fast</b>code</span>
        </a>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{url('/dist/img/user3-128x128.jpg')}}" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{url('/dist/img/user4-128x128.jpg')}}" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
    ...
    <footer class="main-footer">
        ...
        <strong>Virtual IVR &copy; 2017 {{ Html::link('http://www.fastcode.today', 'Fastcode Site') }}.</strong>
    </footer>
