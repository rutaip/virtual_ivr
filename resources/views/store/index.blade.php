                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('amount', ['56' => 'Recarga de $ 56 + iva', '490' => 'Recarga de $ 490 + iva', '750' => 'Recarga de $ 750 + iva', '950' => 'Recarga de $ 950 + iva'], null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Virtual IVR', 'autofocus']) !!}
                                            </div>
                                        </div>
                                    </div>
