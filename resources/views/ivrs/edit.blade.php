            ...
            <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edición Endpoint</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="row box-body">
                        {!! Form::model($endpoint, ['method' => 'PATCH', 'url' => 'endpoints/' . $endpoint->id]) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('transport', ['transport-udp' => 'transport-udp','tls' => 'tls'], $endpoint->transport, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('context', 'Contexto') !!}
                                <p class="help-block">Contexto para el endpoint</p>
                                {!! Form::select('context', ['users' => 'users', 'ivr' => 'ivr', 'guest' => 'guest'], $endpoint->context, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('allow[]', ['g729' => 'g729','alaw' => 'alaw','ulaw' => 'ulaw', 'gsm' => 'gsm','opus' => 'opus'], $codecs, ['multiple', 'class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('password', 'Endpoint Password') !!}
                                <p class="help-block">Contraseña para el endpoint</p>
                                {!! Form::text('password', $endpoint->ps_auth->password, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                    ...
                    <div class="box-footer">
                        <div class="btn-group pull-right">
                            {!! Form::submit('Editar endpoint', ['class' => 'btn btn-flat btn-primary']) !!}
